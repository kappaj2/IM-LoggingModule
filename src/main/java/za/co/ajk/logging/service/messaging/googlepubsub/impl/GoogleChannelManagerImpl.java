package za.co.ajk.logging.service.messaging.googlepubsub.impl;
...
import za.co.ajk.logging.config.MessageImplementationCondition;
    ...
    public PubSubInboundChannelAdapter messageChannelAdapterGenericSub(
        ...
        try {
            PubSubInboundChannelAdapter adapter =
                new PubSubInboundChannelAdapter(pubSubTemplate, "LoggingGenericSub");
            adapter
                .setOutputChannel(
